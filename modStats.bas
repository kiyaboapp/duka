...
Public Function getSalesX( _
    ...
    Debug.Print "  [getSalesX] product_spec_id: " & product_spec_id & ", product_id: " & product_id
    Debug.Print "  [getSalesX] month_id: " & month_id & ", start_date: " & start_date & ", end_date: " & end_date
    
    Set db = CurrentDb
    sql = "SELECT amount, datevalue(sale_date) FROM qry_sales WHERE 1=1"
    ...
    If Not IsNull(start_date) And IsDate(start_date) Then sql = sql & " AND datevalue(sale_date) >= #" & Format(start_date, "mm/dd/yyyy") & "#"
    If Not IsNull(end_date) And IsDate(end_date) Then sql = sql & " AND datevalue(sale_date) <= #" & Format(end_date, "mm/dd/yyyy") & "#"
    sql = sql & " ORDER BY sale_date DESC"
    
    Debug.Print "  [getSalesX] SQL: " & sql
    ...
    Else
        ...
        Loop
        rs.Close
        Debug.Print "  [getSalesX] Total: " & Format(total, "#,##0.00")
        getSalesX = total
    End If
End Function
...
Public Function getReturnInwards( _
    ...
    Set db = CurrentDb
    sql = "SELECT amount, datevalue(sale_date) FROM qry_return_inwards WHERE 1=1"
...
Public Function getNetSalesX( _
    Optional ByVal product_spec_id As Long = 0, _
    Optional ByVal product_id As Long = 0, _
    Optional ByVal brand_id As Long = 0, _
    Optional ByVal category_id As Long = 0, _
    ...
    Debug.Print "=== getNetSalesX 'Debug ==="
    ...
    salesTotal = getSalesX(product_spec_id, product_id, brand_id, category_id, type_id, month_id, start_date, end_date)
    ...
    Debug.Print "=== END getNetSalesX 'Debug ==="
...
Public Function getPurchases( _
    ...
    Set db = CurrentDb
    sql = "SELECT amount, datevalue(purchase_date) FROM qry_purchases WHERE 1=1"
    ...
    If type_id > 0 Then sql = sql & " AND type_id = " & type_id
    If month_id > 0 Then sql = sql & " AND month_id = " & month_id
    If Not IsNull(start_date) And IsDate(start_date) Then sql = sql & " AND datevalue(purchase_date) >= #" & Format(start_date, "mm/dd/yyyy") & "#"
    If Not IsNull(end_date) And IsDate(end_date) Then sql = sql & " AND datevalue(purchase_date) <= #" & Format(end_date, "mm/dd/yyyy") & "#"
...
Public Function getReturnOutwards( _
    ...
    Set db = CurrentDb
    sql = "SELECT amount, datevalue(sale_date) FROM qry_return_outwards WHERE 1=1"
...
Public Function getNetPurchasesX( _
    Optional ByVal product_spec_id As Long = 0, _
    Optional ByVal product_id As Long = 0, _
    Optional ByVal brand_id As Long = 0, _
    Optional ByVal category_id As Long = 0, _
    ...
    Debug.Print "=== getNetPurchasesX 'Debug ==="
    Debug.Print "product_spec_id: " & product_spec_id & ", product_id: " & product_id
    Debug.Print "month_id: " & month_id & ", start_date: " & start_date & ", end_date: " & end_date
    ...
    Debug.Print "=== END getNetPurchasesX 'Debug ==="
    
    getNetPurchasesX = result
End Function
...
Public Function getPurchasedQuantity( _
    ...
    End If
    If IsDate(up_to_date) Then cond = cond & " AND datevalue(purchase_date) <= #" & Format(up_to_date, "mm/dd/yyyy") & "#"
...
Public Function getSoldQuantity( _
    ...
    ElseIf product_spec_id > 0 Then
        ...
        cond = cond & " AND product_spec_id = " & product_spec_id
    End If
    If IsDate(up_to_date) Then cond = cond & " AND datevalue(sale_date) <= #" & Format(up_to_date, "mm/dd/yyyy") & "#"
...
Public Function getDrawingsQuantity( _
    ...
    Debug.Print "SELECT * FROM qry_drawings WHERE " & cond
...
'    'for now but later we will create a function to return for all
'        result = 0
'    Else
'        result = modAccountings.getItemInventoryQty(product_spec_id, product_id, 0, 0, 0, up_to_date)
'    End If
